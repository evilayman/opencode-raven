...
const DEFAULT_ON_DEMAND_MCP_SERVERS: Record<string, OnDemandMcpServer> = {
  ...
  tavily: {
    ...
    description: "Structured web search, Q&A, and news with pre-extracted answer snippets.",
  },
}
...
const DEFAULT_ON_DEMAND_MCP_METADATA: Record<string, OnDemandMcpMetadata> = {
  ...
  tavily: {
    autoGeneratedDescription: "Performs structured web search and Q&A with pre-extracted answer snippets; best for keyword/factual queries, news, and RAG-style search that reduces token usage.",
  },
}
